...
function ns.AssembleBlockTabs(addon, options, ctx)
	...
	options.args.essential = {
		...
		args = mergeArgs(
			...
			ns.BuildPanelContentArgs(ctx, "essential", 200)
		),
	}
	...
	options.args.utility = {
		...
		args = mergeArgs(
			...
			ns.BuildPanelContentArgs(ctx, "utility", 200)
		),
	}
	...
	options.args.buff = {
		...
		args = mergeArgs(
			...
			ns.BuildPanelContentArgs(ctx, "buff", 200)
		),
	}
	...
	options.args.buffBar = {
		...
		args = mergeArgs(
			...
			ns.BuildPanelContentArgs(ctx, "buffBar", 200)
		),
	}
